export function Footer() {
  return (
    <footer className="border-t border-amber-200/60 bg-white/90 py-8">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 text-sm text-slate-600 sm:flex-row">
        ...
        <div className="flex items-center gap-2 rounded-md bg-amber-600/10 px-3 py-1 text-amber-800">
